...
type DomainConfService struct {
	rest.RestApi
}

func (f *DomainConfService) Get(ctx context.Context,r *rest.Request) (interface{}, error) {

	logger.Finest("DomainConfService get function.")
	...
	switch action {
	case "list":
		datas, count, err = models.GetDomainConfLists(siteid, appid, stypes,contents,order, sort, num, start)
	case "count":
		count, err = models.GetDomainConfCount(siteid, appid, stypes, contents, order, sort)
	default:
		if id > 0 {
			datas, count, err = models.GetDomainConf(id, siteid, appid)
		}
	}
...
func (f *DomainConfService) Post(ctx context.Context,r *rest.Request) (interface{}, error) {

	logger.Finest("DomainConfService POST function.")
	...
	id, err = models.PostDomainConf(appid,siteid,token,param)
...
func (f *DomainConfService) Put(ctx context.Context,r *rest.Request) (interface{}, error) {

	logger.Finest("DomainConfService Put function.")
	...
	cnt, err := models.PutDomainConf(id, param)
...
func (f *DomainConfService) Delete(ctx context.Context,r *rest.Request) (interface{}, error) {

	logger.Finest("DomainConfService Delete function.")
	...
	cnt, err := models.DeleteDomainConf(id, param)
