...
func (f *AppidService) Get(ctx context.Context,r *rest.Request) (interface{}, error) {

	logger.Finest("AppidService get function.")
	...
	switch action {
	case "list":
		datas, count, err = models.GetAppidLists(siteid, appid, stypes,contents,order, sort, num, start)
	case "count":
		count, err = models.GetAppidCount(siteid, appid, stypes, contents, order, sort)
	default:
		if id > 0 {
			datas, count, err = models.GetAppid(id, siteid, appid)
		}
	}
...
func (f *AppidService) Post(ctx context.Context,r *rest.Request) (interface{}, error) {

	logger.Finest("AppidService POST function.")
	...
	id, err = models.PostAppid(appid,siteid,token,param)
...
func (f *AppidService) Put(ctx context.Context,r *rest.Request) (interface{}, error) {

	logger.Finest("AppidService Put function.")
	...
	cnt, err := models.PutAppid(id, param)
...
func (f *AppidService) Delete(ctx context.Context,r *rest.Request) (interface{}, error) {

	logger.Finest("AppidService Delete function.")
	...
	cnt, err := models.DeleteAppid(id, param)
