...
func (f *GroupService) Get(ctx context.Context,r *rest.Request) (interface{}, error) {

	logger.Finest("GroupService get function.")
	...
	switch action {
	case "list":
		datas, count, err = models.GetGroupLists(ctx,siteid, appid, stypes, contents, order, sort, num, start)
	case "count":
		count, err = models.GetGroupCount(ctx,siteid, appid, stypes, contents, order, sort)
	default:
		if id > 0 {
			datas, count, err = models.GetGroup(ctx,id, siteid, appid)
		}
	}
...
func (f *GroupService) Post(ctx context.Context,r *rest.Request) (interface{}, error) {

	logger.Finest("GroupService POST function.")
	...
	id, err = models.PostGroup(ctx,siteid, appid, token, param)
...
func (f *GroupService) Put(ctx context.Context,r *rest.Request) (interface{}, error) {

	logger.Finest("GroupService Put function.")
	...
	cnt, err := models.PutGroup(ctx,siteid, appid, id, token, param)
...
func (f *GroupService) Delete(ctx context.Context,r *rest.Request) (interface{}, error) {

	logger.Finest("GroupService Delete function.")
	...
	cnt, err := models.DeleteGroup(ctx,id, param)
