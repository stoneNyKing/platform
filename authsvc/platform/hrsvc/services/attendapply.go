...
type AttendanceApplyService struct {
	rest.RestApi
}

func (f *AttendanceApplyService) Get(ctx context.Context,r *rest.Request) (interface{}, error) {

	logger.Finest("AttendanceApplyService get function.")
	...
	switch action {
	case "list":
		datas, count, err = models.GetAttendanceApplyLists(ctx,siteid, appid, stypes, contents, order, sort, num, start)
	case "count":
		count, err = models.GetAttendanceApplyCount(ctx,siteid, appid, stypes, contents, order, sort)
	default:
		if id > 0 {
			datas, count, err = models.GetAttendanceApply(ctx,id, siteid, appid)
		}
	}
...
func (f *AttendanceApplyService) Post(ctx context.Context,r *rest.Request) (interface{}, error) {

	logger.Finest("AttendanceApplyService POST function.")
	...
	id, err = models.PostAttendanceApply(ctx,siteid, appid, token, param)
...
func (f *AttendanceApplyService) Put(ctx context.Context,r *rest.Request) (interface{}, error) {

	logger.Finest("AttendanceApplyService Put function.")
	...
	cnt, err := models.PutAttendanceApply(ctx,siteid, appid, id, token, param)
...
func (f *AttendanceApplyService) Delete(ctx context.Context,r *rest.Request) (interface{}, error) {

	logger.Finest("AttendanceApplyService Delete function.")
	...
	cnt, err := models.DeleteAttendanceApply(ctx,id, param)
