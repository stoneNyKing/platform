...
type SchedMonthlyService struct {
	rest.RestApi
}

func (f *SchedMonthlyService) Get(ctx context.Context,r *rest.Request) (interface{}, error) {

	logger.Finest("SchedMonthlyService get function.")
	...
	switch action {
	case "list":
		datas, count, err = models.GetSchedMonthlyLists(ctx,siteid, appid, stypes, contents, order, sort, num, start)
	case "count":
		count, err = models.GetSchedMonthlyCount(ctx,siteid, appid, stypes, contents, order, sort)
	default:
		if id > 0 {
			datas, count, err = models.GetSchedMonthly(ctx,id, siteid, appid)
		}
	}
...
func (f *SchedMonthlyService) Post(ctx context.Context,r *rest.Request) (interface{}, error) {

	logger.Finest("SchedMonthlyService POST function.")
	...
	id, err = models.PostSchedMonthly(ctx,siteid, appid, token, param)
...
func (f *SchedMonthlyService) Put(ctx context.Context,r *rest.Request) (interface{}, error) {

	logger.Finest("SchedMonthlyService Put function.")
	...
	cnt, err := models.PutSchedMonthly(ctx,siteid, appid, id, token, param)
...
func (f *SchedMonthlyService) Delete(ctx context.Context,r *rest.Request) (interface{}, error) {

	logger.Finest("SchedMonthlyService Delete function.")
	...
	cnt, err := models.DeleteSchedMonthly(ctx,id, param)
