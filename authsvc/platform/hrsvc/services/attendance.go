...
func (f *AttendanceService) Get(ctx context.Context,r *rest.Request) (interface{}, error) {

	logger.Finest("AttendanceService get function.")
	...
	switch action {
	case "list":
		datas, count, err = models.GetAttendanceLists(ctx,siteid, appid, stypes, contents, order, sort, num, start)
	case "count":
		count, err = models.GetAttendanceCount(ctx,siteid, appid, stypes, contents, order, sort)
	default:
		if id > 0 {
			datas, count, err = models.GetAttendance(ctx,id, siteid, appid)
		}
	}
...
func (f *AttendanceService) Post(ctx context.Context,r *rest.Request) (interface{}, error) {

	logger.Finest("AttendanceService POST function.")
	...
	id, err = models.PostAttendance(ctx,siteid, appid, token, param)
...
func (f *AttendanceService) Put(ctx context.Context,r *rest.Request) (interface{}, error) {

	logger.Finest("AttendanceService Put function.")
	...
	cnt, err := models.PutAttendance(ctx,siteid, appid, id, token, param)
...
func (f *AttendanceService) Delete(ctx context.Context,r *rest.Request) (interface{}, error) {

	logger.Finest("AttendanceService Delete function.")
	...
	cnt, err := models.DeleteAttendance(ctx,id, param)
